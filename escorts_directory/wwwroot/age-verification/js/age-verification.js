...
$(document).on('change', '#termsCheckbox', function () {
	...
	if (isChecked) {
		$('#enterButton').css({ 'pointer-events': 'auto', 'opacity': 1 });
	} else {
		$('#enterButton').css({ 'pointer-events': 'none', 'opacity': 0.5 });
	}
});
